...
const routes: Routes = [
  ...
  },
  {
    ...
    path: 'sign-up2',
    loadChildren: () => import('./sign-up2/sign-up2.module').then( m => m.SignUp2PageModule)
  },
  {
    path: 'sign-up3',
    loadChildren: () => import('./sign-up3/sign-up3.module').then( m => m.SignUp3PageModule)
  },
  {
    path: 'aguarde',
    loadChildren: () => import('./aguarde/aguarde.module').then( m => m.AguardePageModule)
  }
